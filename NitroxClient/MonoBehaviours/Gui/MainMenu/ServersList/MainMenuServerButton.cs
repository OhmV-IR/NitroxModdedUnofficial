...
public class MainMenuServerButton : MonoBehaviour
{
    ...
    public void RequestDelete()
    {
        ...
        uGUI_LegendBar.ChangeButton(0, GameInput.FormatButton(GameInput.Button.UICancel, gamePadOnly: true), Language.main.GetFormat("Back"));
        uGUI_LegendBar.ChangeButton(1, GameInput.FormatButton(GameInput.Button.UISubmit, gamePadOnly: true), Language.main.GetFormat("ItemSelectorSelect"));
